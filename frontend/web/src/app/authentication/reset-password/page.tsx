...
export default function RequestResetPage() {
  ...
  return (
    <div>
        ...
        <div>
            <h2 className="text-2xl font-bold text-[#2e89d6]">Réinitialiser le mot de passe</h2>
        ...
        <div className="space-y-2">
            <Label htmlFor="email" className="text-[#3FA9D9] mb-2 block">Adresse email</Label>
            <Input
                id="email"
                type="email"
        ...
        <p className="text-sm text-gray-600">
            <Link className="text-[#2e89d6] underline" href="/authentication/login">Retour à la connexion</Link>
        </p>
        </form>
    </div>
  );
