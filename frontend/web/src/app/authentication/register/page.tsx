    ...
    <div>
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        <div>
          ...
          {errors.fullName && (
            <p id="nompre-error" className="mt-1 text-xs text-red-600">
              {errors.fullName}
            </p>
          )}
        </div>
        ...
        {/* Mot de passe */}
        <div>
          <Label htmlFor="mot-password" className="text-[#3FA9D9] mb-2 block">
            Mot de passe
          </Label>
          <Input
            id="mot-password"
          ...
          />
          {errors.password && (
            <p id="pwd-error" className="mt-1 text-xs text-red-600">
              {errors.password}
            </p>
          )}
        </div>
        ...
        <div>
          <Label
            htmlFor="confirm-mot-password"
            className="text-[#3FA9D9] mb-2 block"
          >
            Confirmer le Mot de passe
          </Label>
          <Input
        ...
        <Button
          type="submit"
          disabled={loading}
          className="w-full bg-[#3FA9D9] hover:bg-[#2B7FB5] text-white hover-cursor"
        >
