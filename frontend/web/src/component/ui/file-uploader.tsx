    ...
    return (
        <div className={cn("space-y-4", className)}>
            <div className="flex items-center justify-between">
                <h3 className="text-sm font-medium">Liste documents téléchargés</h3>
...
export const DropZone: React.FC<DropZoneProps> = ({
                                                      ...
                                                      prompt = 'Clique ou dépose ton fichier ici',
                                                      maxSize: propMaxSize,
    ...
    return (
        <div
            className={cn(
                "relative flex flex-col items-center justify-center rounded-2xl border-4 border-dashed transition-all cursor-pointer shadow-lg",
                "max-w-3xl h-[300px] mx-auto text-center",
                isDragging
        ...
        >
            ...
            {maxSize && <p className="text-xs text-muted-foreground">taille maximale {maxSize}MB</p>}
            <input
                type="file"
                ref={fileInputRef}
                className="hidden"
